...
/*
 ============================================================================================================
 +
 + Local Server :: Variables :: Date, Time and Referrer
 +
 ============================================================================================================
*/
...
/*
 ============================================================================================================
 + Local Server :: Variables :: Date :: Timestamp
 ============================================================================================================
*/
...
/*
 ============================================================================================================
 + Local Server :: Variables :: Date :: RFC
 ============================================================================================================
*/
...
/*
 ============================================================================================================
 + Local Server :: Variables :: Date :: Year, Month and Month Day
 ============================================================================================================
*/
...
/*
 ============================================================================================================
 + Local Server :: Variables :: Time :: Hours, Minutes and Seconds
 ============================================================================================================
*/
...
/*
 ============================================================================================================
 + Local Server :: Variables :: Date :: HASH :: Message Digest Algorithm, Version Number: 5
 ============================================================================================================
*/
...
/*
 ============================================================================================================
 +
 + Local Server :: Variables :: Network Connection Protocols
 +
 ============================================================================================================
*/
...
/*
 ============================================================================================================
 + Local Server :: Variables :: Network Connection Protocols :: Connection Information
 ============================================================================================================
*/
...
/*
 ============================================================================================================
 + Local Server :: Variables :: Protocol :: Connection Request Information
 ============================================================================================================
*/
...
/*
 ============================================================================================================
 + Local Server :: Variables :: Protocol :: Hyper-Text-Transfer-Protocol
 ============================================================================================================
*/
...
/*
 ============================================================================================================
 +
 + Local Server :: Variables :: Hyper-Text-Transfer-Protocols
 +
 ============================================================================================================
*/
...
/*
 ============================================================================================================
 + Local Server :: Variables :: Hyper-Text-Transfer-Protocols :: Remote Server :: Referrer
 ============================================================================================================
*/
...
/*
 ============================================================================================================
 + Database Create Form :: Variables :: Post Variables
 ============================================================================================================
*/
...
$_ARCHITECT_INSTALL_FORM_POST_CREATE_DATABASE_SERVER_DATABASE_HOSTNAME_PORT				= $_POST['Architect_Create_SQL_Database_Server_Database_HostName_Port'];
...
/*
 ============================================================================================================
 + IF: Installation Form Has Not Posted, Display Installation Form
 ============================================================================================================
*/
...
echo ("
		...
		<FORM ACTION=\"?\" METHOD=\"post\">
		Database Management Server Connection :: Settings<HR>
		* <I>Database Server Database HostName</I>:<BR>
			<INPUT TYPE=\"TEXT\" NAME=\"Architect_Create_SQL_Database_Server_Database_HostName\" VALUE=\"localhost\"><BR>
		* <I>Database Server Database HostName Port</I>:<BR>
			<INPUT TYPE=\"TEXT\" NAME=\"Architect_Create_SQL_Database_Server_Database_Port\" VALUE=\"localhost\"><BR>
		* <I>Database Server UserName</I>:<BR>
			<INPUT TYPE=\"TEXT\" NAME=\"Architect_Create_SQL_Database_Server_Database_UserName\" VALUE=\"Database Server UserName\"><BR>
		* <I>Database Server Password</I>:<BR>
			<INPUT TYPE=\"TEXT\" NAME=\"Architect_Create_SQL_Database_Server_Database_Password\" VALUE=\"Database Server Password\"><BR>
		* <I>Database Server Database Name</I>:<BR>
			<INPUT TYPE=\"TEXT\" NAME=\"Architect_Create_SQL_Database_Server_Database_Name\" VALUE=\"Database Server Database Name\"><BR>
		* <I>Database Server Database Name Table' Prefix</I>:<BR>
...
*/
	...
	echo ("[ Done ]<BR>");
	echo ("<FONT COLOR=\"#CD0000\">[&nbsp;*&nbsp;]</FONT> Attempting Connection To Created Database Name: <I>$_ARCHITECT_INSTALL_FORM_POST_CREATE_DATABASE_SERVER_DATABASE_NAME</I>... Wait.<BR>");
...
mysql_query("
CREATE TABLE \"$_ARCHITECT_INSTALL_FORM_POST_CREATE_DATABASE_SERVER_DATABASE_NAME_DATABASE_TABLE_PREFIX\"_messenger_clear_text_file_room (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
...
mysql_query("
CREATE TABLE \"$_ARCHITECT_INSTALL_FORM_POST_CREATE_DATABASE_SERVER_DATABASE_NAME_DATABASE_TABLE_PREFIX\"_messenger_clear_text_messages (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
...
/*
 ============================================================================================================
 + Install :: Default Application Module Data
 ============================================================================================================
*/
...
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_applications(application_file_name,application_file_permission,application_file_permission_camera,application_file_permission_microphone,application_file_permission_location_gps,application_file_permission_location_geo,application_file_permission_location_internet_protocol_address,application_file_status,application_file_timestamp_installation)VALUES('Webspace','1','1','1','1','1','1','1','$_GLOBAL_LOCAL_SERVER_DATE_TIMESTAMP')");
	...
	echo ("<FONT COLOR=\"#CD0000\">[&nbsp;*&nbsp;]</FONT> Installing Packaged Panels... Wait.<BR>");

/*
 ============================================================================================================
 + Install :: Default Panel Application Modules
 ============================================================================================================
*/

mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_panels(panel_file_name,panel_alignment,panel_row,panel_file_status,panel_title,panel_timestamp_installation)VALUES('Applications_Panel','0','1','1','<CENTER><B>Applications Panel</B></CENTER><HR>','$_GLOBAL_LOCAL_SERVER_DATE_TIMESTAMP')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_panels(panel_file_name,panel_alignment,panel_row,panel_file_status,panel_title,panel_timestamp_installation)VALUES('Banned_Networks','0','4','1','<CENTER><B>Banned Networks</B></CENTER><HR>','$_GLOBAL_LOCAL_SERVER_DATE_TIMESTAMP')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_panels(panel_file_name,panel_alignment,panel_row,panel_file_status,panel_title,panel_timestamp_installation)VALUES('Project_Badges','1','1','1','<CENTER><B>Project Badges</B></CENTER><HR>','$_GLOBAL_LOCAL_SERVER_DATE_TIMESTAMP')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_panels(panel_file_name,panel_alignment,panel_row,panel_file_status,panel_title,panel_timestamp_installation)VALUES('Language','1','6','1','<CENTER><B>Set Language</B></CENTER><HR>','$_GLOBAL_LOCAL_SERVER_DATE_TIMESTAMP')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_panels(panel_file_name,panel_alignment,panel_row,panel_file_status,panel_title,panel_timestamp_installation)VALUES('Latest_Articles','0','3','1','<CENTER><B>Latest Articles</B></CENTER><HR>','$_GLOBAL_LOCAL_SERVER_DATE_TIMESTAMP')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_panels(panel_file_name,panel_alignment,panel_row,panel_file_status,panel_title,panel_timestamp_installation)VALUES('Latest_Files','1','3','1','<CENTER><B>Latest Files</B></CENTER><HR>','$_GLOBAL_LOCAL_SERVER_DATE_TIMESTAMP')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_panels(panel_file_name,panel_alignment,panel_row,panel_file_status,panel_title,panel_timestamp_installation)VALUES('Latest_Shouts','1','5','1','<CENTER><B>Latest Shout Messages</B></CENTER><HR>','$_GLOBAL_LOCAL_SERVER_DATE_TIMESTAMP')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_panels(panel_file_name,panel_alignment,panel_row,panel_file_status,panel_title,panel_timestamp_installation)VALUES('Member_Panel','0','2','1','<CENTER><B>Member Panel</B></CENTER><HR>','$_GLOBAL_LOCAL_SERVER_DATE_TIMESTAMP')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_panels(panel_file_name,panel_alignment,panel_row,panel_file_status,panel_title,panel_timestamp_installation)VALUES('Latest_Members','1','4','1','<CENTER><B>Newest Members</B></CENTER><HR>','$_GLOBAL_LOCAL_SERVER_DATE_TIMESTAMP')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_panels(panel_file_name,panel_alignment,panel_row,panel_file_status,panel_title,panel_timestamp_installation)VALUES('RSS_Panel','1','4','1','<CENTER><B>Real-Simple-Syndication</B></CENTER><HR>','$_GLOBAL_LOCAL_SERVER_DATE_TIMESTAMP')");

	echo ("[ Done ]<BR><BR>");

	echo ("-----------------------------------<BR>");
	echo ("<FONT COLOR=\"#CD0000\">[&nbsp;*&nbsp;]</FONT> Installing Specified Administrator Account Details and Services Root Administrator Account ( $_PROJECT_STRING_NAME_SHORT )... Wait.<BR>");
...
/*
 ============================================================================================================
 + Install :: Backup Services Root Administrator-Level Account Details With Specified Administrator Account Password
 ============================================================================================================
*/
...
'',
'',
'Hi ! My name is Cerberus ! I am the Services Root Administration-Level Robot Account ! I can be authenticated with the primary Administrator Credentials. If you are an Administrator You can send commands to me to make me do things.',
...
if (unlink("./Architect/MySQL/MySQL_Generator.php") && unlink("./Architect/MySQL/index.php") && unlink("./Architect/index.php") && unlink("./Architect/ToolKit/index.php") && unlink("./Architect/ToolKit/Installation_ToolKit.php")) {
	...
	echo ("<FONT COLOR=\"#CD0000\">***</FONT> Architect: Error, I was not able to Secure-Delete the Files: <I>'./Architect/MySQL/MySQL_Generator.php', './Architect/MySQL/index.php', './Architect/ToolKit/index.php', './Architect/ToolKit/Installation_ToolKit.php'</I> You will need to manually Secure-Delete this File before proceeding.<BR>");
...
if (rmdir("./Architect/MySQL/") && rmdir("./Architect/ToolKit/")) {
	...
	echo ("<FONT COLOR=\"#CD0000\">***</FONT> Architect: Error: I was not able to Remove the Directory: './Architect/MySQL/' or './Architect/ToolKit/' You will need to manually Remove this Directory before proceeding.<BR>");
...
if (rmdir("./Architect/")) {
	...
	echo ("<FONT COLOR=\"#CD0000\">***</FONT> Architect: Error: I was not able to Remove the Directory: './Architect/' You will need to manually Remove this Directory before proceeding.<BR>");
...
if (unlink("./$_INTERNAL_FILE_ARCHITECT")) {
	...
	echo ("<BIG><FONT COLOR=\"#CD0000\">***</FONT> Architect: Error: I was not able to Secure-Delete the File: '$_INTERNAL_FILE_ARCHITECT' you will need to manually Secure-Delete this File before proceeding.</BIG><BR>");

} // [ + ] IF: Delete Architect Installation Files

	echo ("<BIG><FONT COLOR=\"#CD0000\">***</FONT> Architect: I am Testing the Pre-Hyper-Text-Post-Processor mail() Function. wait...</BIG><BR>");
