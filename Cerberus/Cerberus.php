...
/*
 ...
 +
 +
 + Global System Security :: Master Sanitization Module
 +
 +
 ============================================================================================================
*/
...
if (file_exists($_GLOBAL_SYSTEM_SECURITY_MASTER_SANITIZATION_FILE)) {
	...
	echo ("Kernel Message: Missing :: Security Module :: Master Sanitization");
...
$_KERNEL_MYSQL_DATABASE_SERVER_CONNECT 							= mysql_connect($_ACCESS_DATABASE_SERVER_HOSTNAME, $_ACCESS_DATABASE_SERVER_USERNAME, $_ACCESS_DATABASE_SERVER_PASSWORD);
$_KERNEL_MYSQL_DATABASE_SERVER_DATABASE_NAME_SELECT 					= mysql_select_db($_ACCESS_DATABASE_SERVER_DATABASE_NAME);
...
if ($_KERNEL_MYSQL_DATABASE_SERVER_CONNECT) {
...
if ($_KERNEL_MYSQL_DATABASE_SERVER_DATABASE_NAME_SELECT) {
...
$_GLOBAL_SYSTEM_PLUGIN_STATUS_MASTER_SANITIZATION					= $_DB_Query_Kernel_Settings_Fetch_Array['settings_system_status_security_module_master_sanitization'];
...
/*
 ============================================================================================================
 + Global Member Settings :: Variables :: Member Account :: Authentication :: Attempt Number
 ============================================================================================================
*/
...
/*
 ============================================================================================================
 + Global Member Settings :: Variables :: Member Account :: Lock Status
 ============================================================================================================
*/
...
echo ("Debug: Setting Debug Cookie<BR>");

if (setcookie("test", "test", time()+98000, "/", false, true)) {

echo ("cookie has been set: $COOKIETEST");

} else {

echo ("error cannot set cookie: $COOKIETEST");

}

if (setcookie("test", "test", "time()+98000")) {
...
/*
 ============================================================================================================
 + Registered Member Account Authentication Log :: Write Authentication Data To Authentication Log
 ============================================================================================================
*/
...
/*
 ============================================================================================================
 + Close File :: Registered Member Account :: Authentication Log
 ============================================================================================================
*/
...
/*
 ============================================================================================================
 + The Registered Member Account Password Has Been Verified and Set Exactly: Set Member Account Last Login Internet Protocol Address To Current
 ============================================================================================================
*/

$_DB_Query_Kernel_Login_Set_Member_Status_Account_Last_Login				= $DB->query("UPDATE {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_members SET member_ip_address_last_login='$_GLOBAL_REMOTE_SERVER_ADDRESS' WHERE member_username='$_Kernel_Authenticate_Member_Account_POST_USERNAME_CLEAR'");
...
/*
 ============================================================================================================
 + Registered Member Account Authentication Log :: Write Authentication Attempt Data To Authentication Log
 ============================================================================================================
*/
...
/*
 ============================================================================================================
 + Database Server Query: Check Authentication Log Attempts From Database Server
 ============================================================================================================
*/
...
} // [ + ] IF: Database Query :: Number of Rows
...
/*
 ============================================================================================================
 + Write To File :: Registered Member Account :: Logout Log :: Write Logout Details To Authentication Log
 ============================================================================================================
*/
...
/*
 ============================================================================================================
 + Redirect To Member Account Locked Message
 ============================================================================================================
*/
 ...
 * Do Nothing
**/
} // [ + ] IF: Member Account Locked Status Is: On At Any Time, Destroy Credentials In Cookies and Redirect To Account Locked Message

/*
 ============================================================================================================
 +
 + Internal Security :: Member Account :: Session :: Restrict Logged-In Members To Authorized Internet Protocol Address
 +
 ============================================================================================================
*/
...
/*
 ============================================================================================================
 +
 + System Theme Loop :: Delete, Recreate and Copy To The Global Theme Directory
 +
 ============================================================================================================
*/
...
/*
 ============================================================================================================
 + IF: File Exists: System Set Theme Directory :: Pre-Hyper-Text-Post-Processor Theme File
 ============================================================================================================
*/


//if (file_exists("./Theme/$_GLOBAL_SYSTEM_THEME_DIRECTORY/Theme.php")) {

/*
 ============================================================================================================
 + DELETE: Global Theme Files
 ============================================================================================================
*/

//unlink("./Theme/Global/Theme.php");
//unlink("./Theme/Global/Image/Background/Background.jpg");
//unlink("./Theme/Global/Image/Icon/FavIcon.ico");
//unlink("./Theme/Global/Image/Icon/No_Image.png");
//unlink("./Theme/Global/Style_Sheet/Style.css");

/*
 ============================================================================================================
 + COPY: System Set Theme Files TO Global Theme Directory
 ============================================================================================================
*/

//copy("./Theme/$_GLOBAL_SYSTEM_THEME_DIRECTORY/Theme.php", "./Theme/Global/Theme.php");
//copy("./Theme/$_GLOBAL_SYSTEM_THEME_DIRECTORY/Image/Background/Background.jpg", "./Theme/Global/Image/Background/Background.jpg");
//copy("./Theme/$_GLOBAL_SYSTEM_THEME_DIRECTORY/Image/Icon/FavIcon.ico", "./Theme/Global/Image/Icon/FavIcon.ico");
//copy("./Theme/$_GLOBAL_SYSTEM_THEME_DIRECTORY/Image/Icon/No_Image.png", "./Theme/Global/Image/Icon/No_Image.png");
//copy("./Theme/$_GLOBAL_SYSTEM_THEME_DIRECTORY/Style_Sheet/Style.css", "./Theme/Global/Style_Sheet/Style.css");

//} // [ + ] IF: File Exists: System Theme Directory :: Pre-Hyper-Text-Post-Processor Theme File
...
$_KERNEL_FIND_APPLICATIONS_ADMINISTRATION_DIRECTORY					= "./Applications/Administration/";
$_KERNEL_OPEN_APPLICATIONS_ADMINISTRATION_DIRECTORY					= opendir($_KERNEL_FIND_APPLICATIONS_ADMINISTRATION_DIRECTORY);

while (($_KERNEL_READ_APPLICATIONS_ADMINISTRATION_DIRECTORY = readdir($_KERNEL_OPEN_APPLICATIONS_ADMINISTRATION_DIRECTORY))) {
...
if ($_KERNEL_READ_APPLICATIONS_ADMINISTRATION_DIRECTORY == "." || $_KERNEL_READ_APPLICATIONS_ADMINISTRATION_DIRECTORY == ".." || $_KERNEL_READ_APPLICATIONS_ADMINISTRATION_DIRECTORY == "index.php") {
/**
 * Do Nothing
**/
} else {
...
if ($_GET[$_INTERNAL_APPLICATION_MODULE_ADMINISTRATOR] == "$_KERNEL_READ_APPLICATIONS_ADMINISTRATION_DIRECTORY") {
...
if ($_GLOBAL_COOKIE_MEMBER_USERNAME && $_GLOBAL_COOKIE_MEMBER_PASSWORD != null && $_GLOBAL_MEMBER_ACCESS_LEVEL >= 2) {
	...
	include_once "./Applications/Administration/$_KERNEL_READ_APPLICATIONS_ADMINISTRATION_DIRECTORY";
...
closedir($_KERNEL_OPEN_APPLICATIONS_ADMINISTRATION_DIRECTORY);
...
echo ("
		<CENTER>
			This Web Site Is Powered By:&nbsp;<A HREF=\"https://www.SourceForge.net/projects/cerberuscms\" TARGET=\"_NEW\" TITLE=\"$_PROJECT_STRING_NAME_EXTENDED :: SourceForge Software Project Page\">$_PROJECT_STRING_NAME_EXTENDED</A>&nbsp;|&nbsp;Web-Page Data Generation Time: " . $_KERNEL_WEBPAGE_GENERATION_TIME_TOTAL_TIME . " Seconds&nbsp;|&nbsp;");
...
if ($DB->close($_KERNEL_MYSQL_DATABASE_SERVER_CONNECT)) {
