...
/*
 ...
 +
 +
 + My-Structured-Query-Language :: Generator :: Tables
 +
 +
 ============================================================================================================
*/
...
id MEDIUMINT NOT NULL AUTO_INCREMENT,
member_access_level VARCHAR(1),
member_attempt_authentication VARCHAR(1),
...
member_status_account_last_active_years VARCHAR(4),
member_status_account_last_active_months VARCHAR(2),
member_status_account_last_active_days VARCHAR(2),
member_status_account_last_active_hours VARCHAR(2),
member_status_account_last_active_minutes VARCHAR(2),
member_status_account_last_active_seconds VARCHAR(2),
